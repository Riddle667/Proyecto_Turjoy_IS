...
@section('content')
    <div
        class="w-full lg:max-w-xl p-6  space-y-8 sm:p-8 bg-white    rounded-lg shadow-xl dark:bg-gray-800 z-20 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-56 border border-black">
            ...
            <ul>
                    ...
                    <div class="flex">
                        ...
                        <div class="w-1/2 bg-gray-custom-150 ">
                            <p class="text-black font-semibold  mt-2 ml-4">
                                {{ date('d/m/Y', strtotime($tickets->reservation_date)) }}</p>
                        </div>
                    </div>
                </li>
                <li>
                ...
                <li>
                    <div class="flex">
                        ...
                        <div class="w-1/2 bg-gray-custom-150 ">
                            <p class="text-black font-semibold  mt-2 ml-4">
                                {{ date('d/m/Y h:i:s', strtotime($vouchers->created_at)) }}</p>
                        </div>
                    </div>
                </li>
                <li>
                ...
                <li>
                    <div class="flex">
                        ...
                        <div class="w-1/2 bg-gray-custom-150 ">
                            <p class="text-black font-semibold  mt-2 ml-4">{{ $tickets->pay_method }}</p>
                        </div>
                    </div>
                </li>
            </ul>
