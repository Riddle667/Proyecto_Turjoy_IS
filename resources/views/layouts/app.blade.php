...
<body>
        ...
        <nav class=" bg-gray-custom-100 border-gray-200 dark:bg-gray-900">
            <div class=" full-w-screen-xl flex flex-wrap items-center justify-between mx-auto">
                ...
                <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                    <a href = "{{ route('login') }}"
                        class=" rounded-lg shadow-md text-white font-mulish-bold bg-blue-700  hover:bg-blue-800 font-medium text-xl px-7 py-8 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Iniciar
                        sesión</a>
                </div>
            </div>
        </nav>
    ...
    <footer>
        <p>
            <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 TurJoy™. Todos los
