                            ...
                            <tbody>
                                @foreach ($orderRows as $orderRow)
                                    @if ($colors[$loop->index] == '0')
                                        <tr
                                            class="bg-green-400 border-b border-black dark:bg-gray-900 dark:border-gray-700">
                                            <th scope="row"
                                    ...
                                    @if ($colors[$loop->index] == '1')
                                        <tr
                                            class="bg-yellow-400 border-b border-black dark:bg-gray-900 dark:border-gray-700">
                                            <th scope="row"
                                                class="px-6 py-4 font-medium text-black whitespace-nowrap dark:text-white">
                                                {{ $orderRow['origen'] ? $orderRow['origen'] : '---' }}
                                            </th>
        ...
        @else
            <div class="flex">
                ...
                <div class=" w-10/12 ">
                    ...
                    <div>
                        <p class="text-black font-bold text-sm m-1">Seleccione el archivo a subir</p>
                        <form class="flex flex-col ml-1 w-1/2 mx-4 mr-auto" action="{{ route('route.check') }}"
                        ...
                        <table class="table-auto rounded-xl bg-gray-custom-150">
                            <tbody>
                                ...
                                <tr>
                                    <td class="border px-4 py-2 border-black bg-green-custom">-Se cargaron correctamente
                                    </td>
                                </tr>
                                <tr>
                                    <td class="border px-4 py-2 border-black bg-red-custom-50">
