...
@section('content')
    <div
        class=" lg:max-w-xl max-h-screen p-10 space-y-8 sm:p-8 bg-gray-custom-150   rounded-lg shadow-xl dark:bg-gray-800 z-20 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-56 border border-black">
